...
- Manually edit the project's .zap file (located in config/zap/ in the project directory) to add the following block to the "keyValuePairs" array.
 ...
 ```
For an example, see [Sample ZAP file](https://github.com/SiliconLabsSoftware/matter_extension/blob/main/slc/apps/performance_test_app/thread/performance-test-app.zap)
