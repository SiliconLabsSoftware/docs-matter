...
| `ApplicationEventHandlerImpl` | `ApplicationEventHandler` | Toggles the LED for a user action button press. |
...
| `OnICDModeChangeImpl` | `OnICDModeChange` | Logs the change between SIT and LIT operating modes. Available when `CHIP_CONFIG_ENABLE_ICD_SERVER` is enabled. |
