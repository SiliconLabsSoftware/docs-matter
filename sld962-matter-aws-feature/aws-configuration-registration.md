...
7. Complete the following steps to create a thing and generate certificates for your Matter application to use in the `MatterAwsNvmCert.cpp` source file:
    ...
    - Under **Configure device certificate > Device Certificate**. 
      - Select **Auto-generate a new certificate** (For 917 NCP Dual Stack)
      ...
      - select **Upload CSR**. (For 917 NCP and 917 SoC)
...
8. Copy the contents of [AWS_CA CERT](https://www.amazontrust.com/repository/AmazonRootCA3.pem) (We are using Amazon Root CA3 for 917 NCP and 917 Soc and Amazon Root CA1 for 917 Dual Stack) and add it as CA certificate in `examples/platform/silabs/matter_aws/matter_aws_interface/include/MatterAwsNvmCert.cpp`. 
