...
NOTE: The chip-tool binary is a part of the software artifacts package provided with the Matter release, see "Assets" section at the bottom of this page:  https://github.com/SiliconLabs/matter_extension/releases/tag/v2.3.0 . In most cases it should not be necessary to build chip-tool from scratch. 
