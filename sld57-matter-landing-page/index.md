...
4. **[Optional] Customize Matter App Behavior and Logic**
   ...
   - Customize app behavior in `CustomerAppTask` and `autogen/AppTask.cpp`. For more information, see [Matter API Reference](/matter/{build-docspace-version}/matter-api-reference/).
