...
5. **Build and Flash**
   - Refer back to documentation for quick-start demo for your desired protocol, complete steps for building and flashing app 
   ...
   - Ensure bootloader is present on the device
     ...
     - If you are not using a solution based example, flash the bootloader from [Matter Software Artifacts](https://docs.silabs.com/matter/latest/matter-prerequisites/matter-artifacts#matter-bootloader-binaries)
