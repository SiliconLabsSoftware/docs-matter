...
4. **[Optional] Customize Matter App Behavior and Logic**
   ...
   - Customize app behavior in `CustomerAppTask` and `autogen/AppTask.cpp` — see [Extending Base App Implementation](/matter/{build-docspace-version}/matter-references/custom-matter-device/#extending-base-app-implementation).
