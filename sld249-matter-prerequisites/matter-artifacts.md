...
<https://github.com/SiliconLabs/matter_extension/releases/tag/v2.2.2>
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.2.2/ot-rcp-binaries-2.2.2-1.2.zip
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.2.2/matter-accessory-device-images_2.2.2-1.2.zip
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.2.2/bootloader_binaries_matter_extension_v2.2.2-1.2.zip
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.2.2/rs9116_firmware_files_with_rev_2.2.2-1.2.zip
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.2.2/SiWx917NCP_firmware_files_2.2.2-1.2.zip
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.2.2/SiWx917SOC_firmware_files_2.2.2-1.2.zip
...
The [JLinkDevices.xml](https://github.com/SiliconLabs/matter_extension/releases/download/v2.2.2/JLinkDevices.xml) and **.elf** files referenced in the instructions may be found in the Assets section of this page.
