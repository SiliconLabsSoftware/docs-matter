...
https://github.com/SiliconLabs/matter_extension/releases/tag/v2.5.1
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.5.1/ot-rcp-binaries-2.5.1-1.4.zip
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.5.1/matter-accessory-device-images_2.5.1-1.4.zip
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.5.1/bootloader_binaries_matter_extension_v2.5.1-1.4.zip
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.5.1/rs9116_firmware_files_with_rev_2.5.1-1.4.zip
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.5.1/SiWx917NCP_firmware_files_2.5.1-1.4.zip
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.5.1/SiWx917SOC_firmware_files_2.5.1-1.4.zip
...
The [JLinkDevices.xml](https://github.com/SiliconLabs/matter_extension/releases/download/v2.5.1/JLinkDevices.xml.zip) and [RS9117_SF_4MB_42bsp.elf](https://github.com/SiliconLabs/matter_extension/releases/download/v2.5.1/RS9117_SF_4MB_42bsp.elf.zip) files referenced in the instructions may be found in the Assets section of this page.
