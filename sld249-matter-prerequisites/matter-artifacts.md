...
https://github.com/SiliconLabs/matter_extension/releases/tag/v2.5.0
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.5.0/ot-rcp-binaries-2.5.0-1.4.zip
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.5.0/matter-accessory-device-images_2.5.0-1.4.zip
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.5.0/rs9116_firmware_files_with_rev_2.5.0-1.4.zip
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.5.0/SiWx917NCP_firmware_files_2.5.0-1.4.zip
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.5.0/SiWx917SOC_firmware_files_2.5.0-1.4.zip
...
The [JLinkDevices.xml](https://github.com/SiliconLabs/matter_extension/releases/download/v2.5.0/JLinkDevices.xml.zip) and [RS9117_SF_4MB_42bsp.elf](https://github.com/SiliconLabs/matter_extension/releases/download/v2.5.0/RS9117_SF_4MB_42bsp.elf.zip) files referenced in the instructions may be found in the Assets section of this page.
