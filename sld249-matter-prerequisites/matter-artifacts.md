...
https://github.com/SiliconLabs/matter_extension/releases/tag/v2.3.2
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.3.2/ot-rcp-binaries-2.3.2-1.3.zip
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.3.2/matter-accessory-device-images_2.3.2-1.3.zip
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.3.2/bootloader_binaries_matter_extension_v2.3.2-1.3.zip
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.3.2/rs9116_firmware_files_with_rev_2.3.2-1.3.zip
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.3.2/SiWx917NCP_firmware_files_2.3.2-1.3.zip
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.3.2/SiWx917SOC_firmware_files_2.3.2-1.3.zip
...
The [JLinkDevices.xml](https://github.com/SiliconLabs/matter_extension/releases/download/v2.3.2/JLinkDevices.xml.zip) and [RS9117_SF_4MB_42bsp.elf](https://github.com/SiliconLabs/matter_extension/releases/download/v2.3.2/RS9117_SF_4MB_42bsp.elf.zip) files referenced in the instructions may be found in the Assets section of this page.
