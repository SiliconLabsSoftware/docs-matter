...
https://github.com/SiliconLabs/matter_extension/releases/tag/v2.4.0
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.4.0/ot-rcp-binaries-2.4.0-1.4.zip
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.4.0/matter-accessory-device-images_2.4.0-1.4.zip
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.4.0/bootloader_binaries_matter_extension_v2.4.0-1.4.zip
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.4.0/rs9116_firmware_files_with_rev_2.4.0-1.4.zip
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.4.0/SiWx917NCP_firmware_files_2.4.0-1.4.zip
...
https://github.com/SiliconLabs/matter_extension/releases/download/v2.4.0/SiWx917SOC_firmware_files_2.4.0-1.4.zip
...
In order to check device logs on JLink RTT for the Matter Application on the SiWx917 SoC, the **JLink RTT** must be configured for the SiWx917 SoC device by following the instructions on the [JLink RTT SOC Support](/matter/{build-docspace-version}/matter-wifi-enabling-features/jlink-soc-setup) for SiWx917 SoC.

The [JLinkDevices.xml](https://github.com/SiliconLabs/matter_extension/releases/download/v2.4.0/JLinkDevices.xml.zip) and [RS9117_SF_4MB_42bsp.elf](https://github.com/SiliconLabs/matter_extension/releases/download/v2.4.0/RS9117_SF_4MB_42bsp.elf.zip) files referenced in the instructions may be found in the Assets section of this page.
