...
- For rs9116 and WF200 - `matter_icd` component is added by default for lock-app. For thermostat and window need to add mentioned component to enable sleepy.
- For 917NCP - `matter_icd` component is added by default for lock-app. For thermostat and window need to add mentioned component to enable sleepy.
- For SiWx917 SOC add - `matter_icd` and remove `matter_subscription_timeout_resumption` from **.slcp** project file for lock, window and light-switch.
